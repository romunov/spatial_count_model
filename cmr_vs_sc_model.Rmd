...
set.seed(12)
mark.binom.N <- SCR0binom.cl(y = binom.augmented.y, X = X, M = M, xl = xl, xu = xu, yl = yl, yu = yu, K = K, 
                             delta = c(1, 0.1, 2), niter = 100000)

mark.binom.N.mcmc <- mcmc(mark.binom.N)
summary(window(mark.binom.N.mcmc, start = start))
...
un.N <- scrUN(n = n, X = X, M = 200, niter = 100000, xlims = xlim, ylims = ylim,
