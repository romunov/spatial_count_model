...
sim.poisson <- parLapplyLB(cl = cs, X = 1:6, fun = paraFunction, data.model = "poisson", niter = 5000)
sim.binomial <- parLapplyLB(cl = cs, X = 1:6, fun = paraFunction, data.model = "binomial", niter = 5000)
```
